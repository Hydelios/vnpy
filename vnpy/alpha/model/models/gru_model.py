...
class GruModel(AlphaModel):
    ...
    使用GRU神经网络实现的Alpha因子预测模型,主要功能包括:
    1. 构建和训练GRU神经网络
    2. 预测Alpha因子值
    3. 模型评估和特征重要性分析
    4. 支持早停和防止过拟合
    ...
    def __init__(
        ...
        hidden_size: int = 64,                          # GRU隐藏层神经元数量
        ...
        # 初始化GRU网络结构
        self.model: GruNetwork = GruNetwork(
    ...
    def detail(self) -> pd.DataFrame:
        ...
        logger.info(f"GRU隐藏层数量: {self.num_layers}")
